...
<div id="exit-popup" style="display:none;position:fixed;z-index:99999;left:0;top:0;width:100%;height:100%;background:rgba(0,0,0,0.5);align-items:center;justify-content:center;backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);">
  <div style="background:rgba(255,255,255,0.95);padding:30px 28px 24px;border-radius:24px;width:90%;max-width:420px;max-height:90vh;overflow-y:auto;box-shadow:0 20px 60px rgba(0,0,0,0.3);position:relative;text-align:center;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#1d1d1f;">
    ...
    <form id="guide-form" method="POST" action="{{ route('exit-popup.submit') }}">
      ...
      <input type="text" name="name" placeholder="Name" required aria-label="Name" style="width:100%;padding:12px 14px;border:none;border-radius:12px;font-size:16px;font-family:inherit;color:#1d1d1f;background:#f5f5f7;box-sizing:border-box;margin-bottom:10px;transition:all 0.2s;" onfocus="this.style.background='#e8e8ed'" onblur="this.style.background='#f5f5f7'">
      
      <input type="email" name="email" placeholder="Email" required aria-label="Email" style="width:100%;padding:12px 14px;border:none;border-radius:12px;font-size:16px;font-family:inherit;color:#1d1d1f;background:#f5f5f7;box-sizing:border-box;margin-bottom:10px;transition:all 0.2s;" onfocus="this.style.background='#e8e8ed'" onblur="this.style.background='#f5f5f7'">
      
      <input type="tel" name="phone" placeholder="Phone" required aria-label="Phone" style="width:100%;padding:12px 14px;border:none;border-radius:12px;font-size:16px;font-family:inherit;color:#1d1d1f;background:#f5f5f7;box-sizing:border-box;margin-bottom:10px;transition:all 0.2s;" onfocus="this.style.background='#e8e8ed'" onblur="this.style.background='#f5f5f7'">
      
      <input type="number" name="age" placeholder="Senior's Age" min="60" max="120" required aria-label="Age" style="width:100%;padding:12px 14px;border:none;border-radius:12px;font-size:16px;font-family:inherit;color:#1d1d1f;background:#f5f5f7;box-sizing:border-box;margin-bottom:10px;transition:all 0.2s;" onfocus="this.style.background='#e8e8ed'" onblur="this.style.background='#f5f5f7'">
      
      <select name="care_type" required aria-label="Care Type" style="width:100%;padding:12px 14px;border:none;border-radius:12px;font-size:16px;font-family:inherit;color:#1d1d1f;background:#f5f5f7;box-sizing:border-box;margin-bottom:10px;cursor:pointer;appearance:none;background-image:url('data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%2714%27 height=%2714%27 viewBox=%270 0 12 12%27%3E%3Cpath fill=%27%2386868b%27 d=%27M6 9L1 4h10z%27/%3E%3C/svg%3E');background-repeat:no-repeat;background-position:right 14px center;background-color:#f5f5f7;padding-right:40px;transition:all 0.2s;" onfocus="this.style.background='#e8e8ed url(data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%2714%27 height=%2714%27 viewBox=%270 0 12 12%27%3E%3Cpath fill=%27%2386868b%27 d=%27M6 9L1 4h10z%27/%3E%3C/svg%3E) no-repeat right 14px center'" onblur="this.style.background='#f5f5f7 url(data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%2714%27 height=%2714%27 viewBox=%270 0 12 12%27%3E%3Cpath fill=%27%2386868b%27 d=%27M6 9L1 4h10z%27/%3E%3C/svg%3E) no-repeat right 14px center'">
      ...
      <select name="timeline" required aria-label="Timeline" style="width:100%;padding:12px 14px;border:none;border-radius:12px;font-size:16px;font-family:inherit;color:#1d1d1f;background:#f5f5f7;box-sizing:border-box;margin-bottom:16px;cursor:pointer;appearance:none;background-image:url('data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%2714%27 height=%2714%27 viewBox=%270 0 12 12%27%3E%3Cpath fill=%27%2386868b%27 d=%27M6 9L1 4h10z%27/%3E%3C/svg%3E');background-repeat:no-repeat;background-position:right 14px center;background-color:#f5f5f7;padding-right:40px;transition:all 0.2s;" onfocus="this.style.background='#e8e8ed url(data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%2714%27 height=%2714%27 viewBox=%270 0 12 12%27%3E%3Cpath fill=%27%2386868b%27 d=%27M6 9L1 4h10z%27/%3E%3C/svg%3E) no-repeat right 14px center'" onblur="this.style.background='#f5f5f7 url(data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%2714%27 height=%2714%27 viewBox=%270 0 12 12%27%3E%3Cpath fill=%27%2386868b%27 d=%27M6 9L1 4h10z%27/%3E%3C/svg%3E) no-repeat right 14px center'">
